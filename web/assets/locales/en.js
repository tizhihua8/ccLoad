...
window.I18N_LOCALES['en'] = {
  ...
  'channels.clearCooldownBtn': 'Clear Cooldown',
  'channels.clearCooldownTitle': 'Clear Channel Cooldown',
  'channels.clearCooldownDesc': 'Select channels to clear cooldown status. Cooldown will be removed immediately after confirmation.',
  'channels.cooldownChannelCount': 'channels in cooldown',
  'channels.selectAllCooldown': 'Select All',
  'channels.deselectAllCooldown': 'Deselect All',
  'channels.confirmClearCooldown': 'Clear Selected',
  'channels.clearCooldownSuccess': 'Cleared cooldown for {count} channels',
  'channels.clearCooldownNoneSelected': 'Please select at least one channel',
  'channels.noCooldownChannels': 'No channels currently in cooldown',
  'channels.clearCooldownPartial': 'Success {success}, Failed {fail}',
  'channels.clearCooldownFailed': 'Failed to clear cooldown',
  ...
  // Body Operations
  'channels.uaBodyOperations': 'Request Body Rewrite (Body Operations)',
  'channels.uaBodyOperationsHint': 'Supports condition templates: {{if gt .MaxTokens 4096}}true{{end}}. Available vars: Model, MaxTokens, Temperature, Stream',
  'channels.addUABodyOp': 'Add Body Operation',
  'channels.uaBodyOpSet': 'Set Value',
  'channels.uaBodyOpDelete': 'Delete Field',
  'channels.uaBodyOpRename': 'Rename',
  'channels.uaBodyOpCopy': 'Copy',
  'channels.uaBodyOpPath': 'JSON Path (e.g., stream, max_tokens)',
  'channels.uaBodyOpValue': 'Value (supports template, e.g., true or {{if gt .MaxTokens 4096}}true{{end}})',
